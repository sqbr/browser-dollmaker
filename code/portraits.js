...
const wheelchair_list_sprite = ["None",];
...
const wheelchair_back_list_sprite = ["None",];
const coat_back_list_sprite = ["None","cape","cape collar",];
const back_list_sprite = [["Coat", coat_back_list_sprite],["Wheelchair", wheelchair_back_list_sprite] ];
