...
function add_portrait_object(name, list, location){
    ...
    portrait_objects.push({name: name,location: loc, item_list: list, colour: true, value_list: listOf(0), heightOffset: 0, colour1: "#FF0000",colour2: "#00FF00", base_image_list: newImageList(),shadow_image_list: newImageList(),highlight_image_list: newImageList(),overlay_image_list: newImageList()});
}
