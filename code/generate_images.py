...
outfit_list_portOnly= ["Shirt", "Neckwear", "Coat", "Eyewear", "Hat"]
outfit_list_spriteOnly = ["Pants","Shoes"]
outfit_list = outfit_list_portOnly+outfit_list_spriteOnly
...
def write_variables():
    ...
    content.write("const outfit_list = outfit_list_portOnly.concat(outfit_list_spriteOnly);\n")
